...
3. `DenChou/Template/_denchou_defaults_v0.3.1.css` stores DenChou's default settings and palette tokens. DenChou-authored colors should stay in OKLCH and avoid pure black/white.

...
(function () {
  ...
  const groups = {
    ...
    Info: [
      { type: "info", label: "Version", value: "v0.3.0" },
      {
        type: "info-link",
        label: "GitHub",
  ...
  if (!document.getElementById("denchou-styles-injected")) {
    ...
    link.rel = "stylesheet";
    link.type = "text/css";
    link.href = "_denchou_settings_v0.3.0.css";
  ...
  window.denchouReset = async function () {
    ...
    try {
      const response = await fetch("_denchou_defaults_v0.3.0.css");
      if (!response.ok)
        throw new Error(
          "File '_denchou_defaults_v0.3.0.css' not found in media folder.",
        );

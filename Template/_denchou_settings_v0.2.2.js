...
(function () {
  ...
  const groups = {
    Visibility: [
      { type: "header", label: "Desktop / Global" },
      {
        ...
        type: "switch-int",
        desc: "Show the gear icon to open the settings.",
        mobileHidden: true,
      },
      {
        label: "Main Card Background",
        var: "--main-bg-visibility",
        type: "switch-int",
        desc: "Show the main card background.",
        mobileHidden: true,
      },
      {
        label: "Card Shadow",
        var: "--main-bg-shadow-visibility",
        type: "switch-int",
        desc: "Show a drop shadow around the main card background.",
        mobileHidden: true,
      },
      {
        label: "Dark Mode Toggle",
        var: "--custom-dark-mode-visibility",
        type: "switch-int",
        desc: "Show the Sun/Moon icon to toggle the custom dark mode.",
        mobileHidden: true,
      },
      {
        label: "Audio Buttons",
        var: "--audio-visibility",
        type: "switch-int",
        desc: "Show replay buttons for Word/Sentence audio.",
        mobileHidden: true,
      },
      {
        label: "Frequency",
        var: "--freq-visibility",
        type: "switch-int",
        desc: "Show the frequency rank indicator.",
        mobileHidden: true,
      },
      {
        label: "Tags",
        var: "--tag-visibility",
        type: "switch-int",
        desc: "Show tags in the bottom-left area of the card footer.",
      },
      {
        label: "External Links",
        var: "--external-links-visibility",
        type: "switch-int",
        desc: "Show icons for external links such as Jisho, JPDB, Immersion Kit, etc.",
      },

      { type: "header", label: "Smaller Screens (≤ 1050px)" },
      {
        label: "Settings Toggle",
        var: "--settings-visibility-header",
        type: "switch-int",
        desc: "Show the gear icon in the header to open the settings.",
      },
      {
        label: "Main Card Background",
        var: "--main-bg-1050-visibility",
        type: "switch-int",
        desc: "Show the main card background on smaller screens.",
      },
      {
        label: "Card Shadow",
        var: "--main-bg-shadow-1050-visibility",
        type: "switch-int",
        desc: "Show a drop shadow around the main card background on smaller screens.",
      },
      {
        label: "Dark Mode Toggle",
        var: "--custom-dm-header-visibility",
        type: "switch-int",
        desc: "Show the sun/moon icon to toggle the custom dark mode in the header.",
      },
      {
        label: "Audio Buttons",
        var: "--audio-header-visibility",
        type: "switch-int",
        desc: "Show audio buttons in the header.",
      },
      {
        label: "Frequency",
        var: "--freq-header-visibility",
        type: "switch-int",
        desc: "Show the frequency rank in the header.",
      },
    ],
    "Card Behavior": [
      { type: "header", label: "General Settings" },
      {
        ...
        var: "--enable-animations",
        type: "switch-bool",
        desc: "Enable transition animations.",
      },
      {
        label: "Auto Optimize",
        var: "--ankidroid-auto-optimize",
        type: "switch-bool",
        desc: "Automatically reduce shadows and blur on small screens.",
      },
      {
        label: "AnkiDroid Lite Mode",
        var: "--ankidroid-lite",
        type: "switch-bool",
        desc: "Force lite mode regardless of screen size.",
      },

      { type: "header", label: "Front" },
      {
        label: "Expand Sentence (Word)",
        var: "--word-sentence-default-expanded",
        type: "switch-bool",
        desc: "Show sentence on word cards immediately.",
      },
      {
        label: "Expand Sentence (Audio)",
        var: "--audio-sentence-default-expanded",
        type: "switch-bool",
        desc: "Show sentence on audio cards immediately.",
      },
      {
        label: "Expand Hint",
        var: "--hint-default-expanded",
        type: "switch-bool",
        desc: "Show hint on cards immediately.",
      },

      { type: "header", label: "Back" },
      {
        label: "Expand Sentence L1 Note",
        var: "--translation-default-expanded",
        type: "switch-bool",
        desc: "Show the sentence L1 note immediately.",
      },
      {
        label: "Expand Notes",
        var: "--notes-default-expanded",
        type: "switch-bool",
        desc: "Show notes immediately.",
      },
      {
        label: "No Duplicate Kana",
        var: "--no-duplicate-kana",
        type: "switch-bool",
        desc: "Hide the reading for words written entirely in kana.",
      },
      {
        label: "Mute Sentence Audio",
        var: "--mute-sentence-audio",
        type: "switch-bool",
        desc: "Disable automatic sentence audio playback.",
      },
      {
        label: "Auto Play Video",
        var: "--auto-play-video",
        type: "switch-bool",
        desc: "Automatically play videos when shown.",
      },
      {
        label: "Mute Video",
        var: "--mute-video",
        type: "switch-bool",
        desc: "Mute video audio playback.",
      },
    ],
    Typography: [
      { type: "header", label: "General Settings" },
      {
        ...
        var: "--base-size",
        type: "text",
        desc: "Controls the font size of all text.",
      },
      {
        label: "Definition / Glossary Line Height",
      ...
      },
      {
        ...
        var: "--custom-font",
        type: "text",
        desc: "Custom font family name.",
      },
      {
        label: "Serif",
        var: "--serif",
        type: "segment",
        desc: "Target word font family.",
        options: [
          {
            label: "Klee",
            val: '"Klee One", klee, "Hiragino Mincho ProN", "Noto Serif CJK JP", notoserifjp, "Yu Mincho", serif',
          },
          {
            label: "Hiragino",
            val: '"Hiragino Mincho ProN", "Klee One", klee, "Noto Serif CJK JP", notoserifjp, "Yu Mincho", serif',
          },
          {
            label: "Noto",
            val: '"Noto Serif CJK JP", notoserifjp, "Klee One", klee, "Hiragino Mincho ProN", "Yu Mincho", serif',
          },
          {
            label: "Yu",
            val: '"Yu Mincho", "Klee One", klee, "Hiragino Mincho ProN", "Noto Serif CJK JP", notoserifjp, serif',
          },
      ...
      },
      {
        ...
        var: "--sans",
        type: "segment",
        desc: "General font family.",
        options: [
          {
            label: "Gen",
            val: '"Gen Interface JP", "Hiragino Kaku Gothic ProN", "Noto Sans CJK JP", notosansjp, "Segoe UI", sans-serif',
          },
          {
            label: "Hiragino",
            val: '"Hiragino Kaku Gothic ProN", "Noto Sans CJK JP", notosansjp, "Segoe UI", sans-serif',
          },
          {
            label: "Noto",
            val: '"Noto Sans CJK JP", notosansjp, "Hiragino Kaku Gothic ProN", "Segoe UI", sans-serif',
          },
          {
            label: "Segoe",
            val: '"Segoe UI", "Hiragino Kaku Gothic ProN", "Noto Sans CJK JP", notosansjp, sans-serif',
          },
          { label: "Custom", val: "var(--custom-font)" },
        ],
      },
      ...
      {
        label: "Wrapped Sentence Alignment",
        var: "--sentence-alignment",
        type: "segment",
        options: [
          { val: "left", label: "Left" },
        ...
        desc: "Alignment for multi-line sentences.",
      },
      ...
      { type: "header", label: "Reading / Furigana" },
      {
        ...
        desc: "Display the reading above or below the target word.",
      },
      {
        label: "Dynamic Furigana Size",
        var: "--dynamic-furigana-size",
        type: "switch-int",
        desc: "Use automatic sizing for furigana.",
      },
      {
        label: "Word Furigana Size",
        var: "--furigana-size",
        type: "text",
        desc: "Size relative to the target word.",
      },
      {
        label: "Word Furigana Height",
        var: "--furigana-height",
        type: "text",
        desc: "Vertical distance from the word; a negative value moves it up (e.g., -0.05rem).",
      },
      {
        label: "Show Sentence Furigana",
        var: "--sentence-furigana-display",
        type: "switch-int",
      },
      {
        label: "Sentence Furigana Height",
        var: "--sentence-furigana-height",
        type: "text",
        desc: "Vertical distance for sentence furigana; a negative value moves it up (e.g., -0.05rem).",
      },
    ...
    Dimensions: [
      ...
      { type: "sub-header", label: "Dimensions" },
      {
        ...
        var: "--card-max-width",
        type: "text",
        desc: "Maximum width of the content area.",
      },
      {
        label: "Front Offset",
        var: "--front-top-offset",
        type: "text",
        desc: "Vertical positioning for the front card.",
      },
      {
        label: "Back Offset",
        var: "--back-top-offset",
        type: "text",
        desc: "Vertical positioning for the back card.",
      },
      ...
      { label: "XXXL", var: "--spacing-xxxl", type: "text" },
      {
        ...
        var: "--base-padding",
        type: "text",
        desc: "Padding inside the main card container.",
      },
      ...
      { label: "Lightbox Nav", var: "--lightbox-nav-width", type: "text" },
      {
        ...
        var: "--external-links-icon-size",
        type: "text",
      },
      {
        label: "Freq List Height",
        var: "--frequency-max-height",
        type: "text",
      },
    ...
    Dictionary: [
      ...
      {
        label: "Collapse Entries",
        var: "--dictionary-collapse",
        type: "switch-int",
        desc: "Allows dictionary entries to be collapsed.",
      },
      {
        label: "Max Height",
        var: "--dictionary-max-height",
        type: "text",
        desc: "Maximum height before entries collapse.",
      },
      {
        label: "Show Definition Titles",
        var: "--definition-title-visibility",
        type: "switch-int",
        desc: "Show dictionary titles (e.g., 'Jitendex', '大辞泉') in the definition box.",
      },
      {
        label: "Show Glossary Titles",
        var: "--glossary-title-visibility",
        type: "switch-int",
        desc: "Show dictionary titles (e.g., 'Jitendex', '大辞泉') in the glossary box.",
      },
      {
        label: "Dictionary Counter",
        var: "--dictionary-counter-visibility",
        type: "segment",
        options: [
          { val: "1", label: "Always" },
          { val: "0", label: "Toggle" },
        ],
        desc: "Show always or only after toggling.",
      },

      { type: "header", label: "Colorizer" },
      {
        label: "Enable Colorizer",
        var: "--dictionary-colorizer",
        type: "switch-int",
        desc: "Automatically applies a unique color to each dictionary entry.",
      },
      {
        label: "Show Background",
        var: "--dict-bg-enabled",
        type: "switch-int",
        desc: "Adds a background color to individual dictionary boxes.",
      },
      {
        label: "Full Card Background",
        var: "--dict-back-bg",
        type: "switch-int",
        desc: "Applies the dictionary background to the entire card.",
      },
      ...
      {
        label: "Enable POS Header",
        var: "--pos-header",
        type: "switch-int",
        desc: "Extracts Jitendex POS tags into a centered sticky header.",
      },
      {
        label: "Hide Numbered Definitions",
        var: "--jitendex-hide-numbers",
        type: "switch-int",
      },
      {
        label: "Hide Example Sentences",
        var: "--jitendex-hide-examples",
        type: "switch-int",
      },
      {
        label: "Hide Explanations",
        var: "--jitendex-hide-info-gloss",
        type: "switch-int",
      },
      {
        label: "Hide Cross References",
        var: "--jitendex-hide-xref",
        type: "switch-int",
      },
      {
        label: "Hide Graphics",
        var: "--jitendex-hide-graphic",
        type: "switch-int",
      },
      { label: "Hide Notes", var: "--jitendex-hide-notes", type: "switch-int" },
      {
        label: "Hide Antonyms",
        var: "--jitendex-hide-antonyms",
        type: "switch-int",
      },
      { label: "Hide Forms", var: "--jitendex-hide-forms", type: "switch-int" },
      {
        label: "Hide Attribution",
        var: "--jitendex-hide-attribution",
        type: "switch-int",
      },
    ],
    "Pitch Accent": [
      { type: "header", label: "Word" },
      {
        ...
        desc: "Determines whether only the pitch downstep or the entire word is colored according to its pitch pattern.",
      },
      {
        label: "Pitch Position",
        var: "--pitch-position-visibility",
        type: "switch-int",
        desc: "Show pitch downstep position.",
      },
      {
        label: "Pitch Colors",
        var: "--pitch-colors",
        type: "switch-bool",
        desc: "Enables pitch downstep coloring.",
      },
      {
        label: "Sentence Highlight",
        var: "--sentence-pitch-highlight",
        type: "switch-bool",
        desc: "Highlights the target word in the sentence using pitch colors.",
      },
      {
        label: "Kana-Only Pitch Size",
        var: "--only-kana-pitch-size",
        type: "text",
        desc: "Border thickness for kana-only words.",
      },
    ],
    "Kanji Hover": {
      mobileHidden: true,
      items: [
        { type: "header", label: "General" },
        {
          label: "Enable Kanji Hover",
          var: "--enable-kanji-hover",
          type: "switch-bool",
          desc: "Enable Kanji Hover.",
        },
        {
          label: "Show Example Sentences",
          var: "--kanji-hover-sentence-visibility",
          type: "switch-int",
          desc: "Display context sentences within the hover tooltip.",
        },
        {
          label: "Auto-Quote Example Sentences",
          var: "--kanji-hover-auto-quote",
          type: "switch-bool",
          desc: "Wrap the example sentences in quotation marks.",
        },
        {
          label: "Word Font",
          var: "--kanji-hover-word-font",
          type: "segment",
          options: [
            { val: "var(--serif)", label: "Serif" },
            { val: "var(--sans)", label: "Sans" },
            { val: "var(--custom-font)", label: "Custom" },
          ],
          desc: "Select the font style for the word.",
        },
        {
          label: "Word Size",
          var: "--kanji-hover-word-size",
          type: "slider",
          min: "1",
          max: "2",
          step: "0.1",
          unit: "rem",
          desc: "Adjust the scale of the word.",
        },
        {
          label: "Reading Size",
          var: "--kanji-hover-word-reading-size",
          type: "slider",
          min: "0.65",
          max: "1.25",
          step: "0.1",
          unit: "rem",
          desc: "Adjust the scale of the reading.",
        },

        { type: "header", label: "Pitch Accent" },
        {
          label: "Pitch Colors",
          var: "--kanji-hover-pitch-colors",
          type: "switch-bool",
          desc: "Enables pitch downstep coloring.",
        },
        {
          label: "Word / Sentence Highlight",
          var: "--kanji-hover-pitch-highlight",
          type: "switch-bool",
          desc: "Highlights the target kanji and word in the sentence using pitch colors.",
        },
      ],
    },
    "Grid Control": [
      ...
      },
      {
        ...
        var: "--grid-column-min-width",
        type: "text",
        desc: "Minimum width before wrapping occurs.",
      },
      ...
      { type: "header", label: "Default Desktop", mobileHidden: true },
      {
        ...
        desc: "Swaps the word and picture container positions horizontally.",
        mobileHidden: true,
      },
      {
        label: "Vertical",
        var: "--vertical-grid-order",
        type: "segment",
        options: [
          { val: "0", label: "Off" },
          { val: "1", label: "On" },
    ...
    "Backdrop Layout": [
      ...
      {
        label: "Enable Layout",
        var: "--enable-backdrop-layout",
        type: "switch-int",
        desc: "Layers the image behind the text instead of placing it beside it.",
      },
      {
        label: "Backdrop Mode",
        var: "--backdrop-style",
        ...
        desc: "Determines if the image fills the whole card or just the word box.",
      },
      {
        label: "Dynamic Card Height",
        var: "--backdrop-dynamic-height",
        type: "switch-int",
        desc: "Forces the card height to fit the entire image (only for Card BG).",
        mobileHidden: true,
      },

      { type: "header", label: "Visual Adjustments" },
      {
        label: "Card BG Offset",
        var: "--bd-card-bg-front-offset",
        type: "text",
        desc: "Front word offset for Card BG mode.",
      },
      {
        label: "Word BG Offset",
        var: "--bd-word-bg-front-offset",
        type: "text",
        desc: "Front word offset for Word BG mode.",
      },
      {
        label: "Background Box",
        var: "--word-background-box",
        type: "switch-int",
        desc: "Enable the background box behind the text area.",
      },
      {
        label: "Image Opacity",
      ...
      },
      {
        ...
        var: "--backdrop-background-height",
        type: "slider",
        min: "0",
        max: "500",
        step: "10",
        unit: "px",
        desc: "Minimum height of the background image area.",
      },
      {
        ...
        theme: "light",
        type: "color",
        desc: "Changes the color of the text shadow.",
      },
      {
        label: "Text Shadow Color",
        var: "--bd-text-shadow-color",
        theme: "dark",
        type: "color",
        desc: "Changes the color of the text shadow.",
      },
      {
        ...
        max: "1",
        step: "0.1",
        desc: "Increases text readability against dark images.",
      },
      {
        label: "Text Shadow Intensity",
        var: "--bd-text-shadow-opacity",
        theme: "dark",
        type: "slider",
        min: "0",
        max: "1",
        step: "0.1",
        desc: "Increases text readability against bright images.",
      },

      { type: "header", label: "Fade Effects" },
      {
        label: "Card BG Fade",
        var: "--card-background-fade",
        type: "switch-int",
        desc: "Applies a bottom fade to the image in Card Background mode.",
      },
      {
        label: "Card BG Fade Intensity",
        var: "--card-fade-strength",
        type: "slider",
        min: "0",
        max: "100",
        step: "5",
        unit: "%",
        desc: "Visible percentage of the image.",
      },
      {
        label: "Word BG Fade",
        var: "--word-background-fade",
        type: "switch-int",
        desc: "Applies a bottom fade to the image in Word Background mode.",
      },
      {
        label: "Word BG Fade Intensity",
        var: "--word-fade-strength",
        type: "slider",
        min: "0",
        max: "100",
        step: "5",
      ...
      {
        label: "Manual Front Positioning",
        var: "--enable-custom-offsets",
        type: "switch-int",
        desc: "Enables manual overrides to align the front word/sentence with the back side.",
      },
      {
        label: "Word BG Word Offset (≤ 1050px)",
        var: "--bd-word-bg-front-offset-1050",
        type: "text",
        desc: "Front word offset for Word BG mode at 1050px max width.",
        mobileHidden: true,
      },
      {
        label: "Card BG Word Offset (≤ 1050px)",
        var: "--bd-card-bg-front-offset-1050",
        type: "text",
        desc: "Front word offset for Card BG mode at 1050px max width.",
      },
      {
        label: "Word BG Word Offset (Mobile)",
        var: "--bd-word-bg-front-offset-mobile",
        type: "text",
        desc: "Front word offset for Word BG mode on mobile devices.",
      },
    ],
    Picture: [
      { type: "header", label: "General" },
      {
        ...
        var: "--collect-glossary-images",
        type: "switch-bool",
        desc: "Automatically collect glossary images into the picture container.",
      },
      { type: "header", label: "Picture Counter" },
      {
        label: "Visibility",
        var: "--picture-counter-visibility",
        type: "segment",
        options: [
          { val: "1", label: "Always" },
      ...
      {
        label: "Font Size",
        var: "--picture-counter-size",
        type: "slider",
        min: "0.3",
        max: "1.2",
        step: "0.05",
        unit: "rem",
        desc: "Adjust the counter's font size.",
      },
      {
        label: "Background Opacity",
        var: "--picture-counter-bg-opacity",
        type: "slider",
        min: "0",
        max: "1",
        step: "0.1",
        desc: "Opacity of the background box.",
      },
      {
        label: "Shadow Intensity",
        var: "--picture-counter-shadow-intensity",
        type: "slider",
        min: "0",
        max: "1",
        step: "0.1",
        desc: "Adjust the shadow intensity.",
      },
      { type: "header", label: "Dimensions" },
      {
        label: "Max Picture Height",
        var: "--picture-height",
        type: "text",
        desc: "Maximum picture container height.",
      },
      {
        label: "Max Picture Height (≤ 624px)",
        var: "--picture-height-small",
        type: "text",
        desc: "Maximum picture container height on small screens.",
      },
    ],
    "Misc Info": [
      {
        label: "Expand Misc Info",
        var: "--misc-info-default-expanded",
        type: "switch-bool",
        desc: "Show misc info immediately.",
      },
      {
        label: "Misc Info Position",
        var: "--misc-info-above",
        type: "segment",
        options: [
        ...
        desc: "Display Misc Info above or below tags and external links.",
      },
      {
        label: "Bold Misc Info",
        var: "--bold-misc-info",
        type: "switch-int",
        desc: "Make misc info text bold.",
      },
      {
        label: "Wrapped Misc Info Alignment",
        var: "--misc-info-alignment",
        type: "segment",
        options: [
          { val: "left", label: "Left" },
          { val: "center", label: "Center" },
        ...
        desc: "Alignment for multi-line misc info.",
      },
      {
        label: "Misc Info Background",
        var: "--misc-info-bg-visibility",
        type: "switch-int",
        desc: "Show background for misc info.",
      },
    ],
    NSFW: [
      {
        label: "Blur NSFW Pictures",
        var: "--blur-nsfw-picture",
        type: "switch-bool",
        desc: "Blur images tagged as NSFW until clicked.",
      },
      {
        label: "Mute NSFW Audio",
        var: "--mute-nsfw-audio",
        type: "switch-bool",
        desc: "Disable automatic sentence audio playback on NSFW-tagged cards.",
      },
    ],
    Shortcuts: {
      mobileHidden: true,
      items: [
        {
          ...
          var: "--toggle-settings-key",
          type: "keybind",
          desc: "Key to open the settings.",
        },
        {
          label: "Replay Scene",
          var: "--scene-replay-shortcut-key",
          type: "keybind",
          desc: "Key to replay the active scene (only for cards with multiple scenes).",
        },
        {
          label: "Toggle Dark Mode",
          var: "--toggle-custom-dark-mode-key",
          type: "keybind",
          desc: "Key to toggle the custom dark mode.",
        },
        {
          label: "Toggle Lightbox",
          var: "--toggle-picture-lightbox-key",
          type: "keybind",
          desc: "Key to open the image viewer.",
        },
        {
          label: "Toggle Grid",
          var: "--toggle-picture-lightbox-grid-key",
          type: "keybind",
          desc: "Key to toggle the image grid view.",
        },
        {
          label: "Toggle Image Visibility",
          var: "--toggle-image-key",
          type: "keybind",
          desc: "key to show or hide the image.",
        },
        {
          label: "Toggle Image Switch",
          var: "--toggle-image-switch-key",
          type: "keybind",
          isPair: true,
          desc: "Key to switch between images.",
        },
        {
          label: "Toggle Scene Switch",
          var: "--toggle-scene-switch-key",
          type: "keybind",
          isPair: true,
          desc: "Key to switch between scenes.",
        },
        {
          label: "Toggle Dictionary Switch",
          var: "--toggle-dictionary-switch-key",
          type: "keybind",
          isPair: true,
          desc: "Key to switch between dictionary entries.",
        },
      ],
    },
    Theme: [
      ...
      {
        label: "Devoiced Mora",
        var: "--light-devoiced-color",
        type: "color",
        theme: "light",
      },
      {
        label: "Devoiced Mora",
        var: "--dark-devoiced-color",
        type: "color",
        theme: "dark",
      },
      {
      ...
      {
        label: "Tag Text Hover ",
        var: "--tag-color-hover-light",
        type: "color",
        theme: "light",
      },
      {
      ...
      {
        label: "External Links BG",
        var: "--external-links-bg-light",
        type: "color",
        theme: "light",
      },
      {
        label: "External Links BG",
        var: "--external-links-bg",
        type: "color",
        theme: "dark",
      },
      ...
      {
        label: "Misc Info Text",
        var: "--misc-info-text-light",
        type: "color",
        theme: "light",
      },
      {
      ...
      {
        label: "Misc Info Text Hover",
        var: "--misc-info-text-hover-light",
        type: "color",
        theme: "light",
      },
      {
        label: "Misc Info Text Hover",
        var: "--misc-info-text-hover",
        type: "color",
        theme: "dark",
      },
      {
        label: "Misc Info BG",
        var: "--misc-info-bg-light",
        type: "color",
        theme: "light",
      },
      {
      ...
      {
        label: "Misc Info BG Hover",
        var: "--misc-info-bg-hover-light",
        type: "color",
        theme: "light",
      },
      {
        label: "Misc Info BG Hover",
        var: "--misc-info-bg-hover",
        type: "color",
        theme: "dark",
      },
      ...
      {
        label: "Button Hover",
        var: "--buttons-bg-hover-light",
        type: "color",
        theme: "light",
      },
      {
        label: "Button Hover",
        var: "--buttons-bg-hover",
        type: "color",
        theme: "dark",
      },
      ...
      {
        label: "Pitch Position BG",
        var: "--pitch-position-bg-light",
        type: "color",
        theme: "light",
      },
      {
        label: "Pitch Position BG",
        var: "--pitch-position-bg",
        type: "color",
        theme: "dark",
      },
      ...
      {
        label: "Picture Box BG",
        var: "--picture-bg-light",
        type: "color",
        theme: "light",
      },
      {
      ...
      {
        label: "Definition/Glossary Box BG",
        var: "--definition-bg-light",
        type: "color",
        theme: "light",
      },
      {
      ...
      {
        label: "Freq List Box BG",
        var: "--frequency-bg-light",
        type: "color",
        theme: "light",
      },
      {
    ...
    Advanced: [
      ...
      { type: "header", label: "Auto Advance" },
      {
        ...
        var: "--auto-show-answer",
        type: "switch-bool",
        desc: "Automatically show the answer after a delay.",
      },
      {
        label: "Show Answer Delay",
        var: "--show-answer-delay",
        type: "slider",
        min: "0",
        max: "15",
        step: "0.5",
        unit: "s",
        desc: "Delay before showing the answer.",
      },
      {
        label: "Auto Advance",
        var: "--auto-advance",
        type: "switch-bool",
        desc: "Automatically advance to the next card after a delay.",
      },
      {
        label: "Auto Advance Delay",
        var: "--auto-advance-delay",
        type: "slider",
        min: "0",
        max: "15",
        step: "0.5",
        unit: "s",
        desc: "Delay before advancing to the next card.",
      },
      {
        label: "Auto Advance Ease",
        var: "--auto-advance-ease",
        type: "segment",
        desc: "The ease button to automatically click.",
        options: [
          { label: "Again", val: "1" },
          { label: "Hard", val: "2" },
          { label: "Good", val: "3" },
      ...
      },
      {
        ...
        var: "--enable-fade-in",
        type: "switch-bool",
        desc: "Adds a smooth fade-in effect when flipping the card.",
      },
    ],
    Info: [
      { type: "info", label: "Version", value: "v0.2.2" },
      {
        type: "info-link",
        label: "GitHub",
        url: "https://github.com/GoRakuDo/DenChou",
        desc: "Source code & updates",
      },
      {
        type: "info-link",
        label: "GoRakuDo",
        url: "https://gorakudo.org/project/denchou",
  ...
  function getLiveCustomCss() {
    ...
    if (liveTag && liveTag.textContent.trim())
      return liveTag.textContent.trim();
  ...
  function updateBackdropState() {
    ...
    if (!enabled)
      enabled = getComputedStyle(doc)
        .getPropertyValue("--enable-backdrop-layout")
        .trim();

    let style = doc.style.getPropertyValue("--backdrop-style").trim();
    if (!style)
      style = getComputedStyle(doc).getPropertyValue("--backdrop-style").trim();
  ...
  if (!document.getElementById("denchou-styles-injected")) {
    ...
    link.rel = "stylesheet";
    link.type = "text/css";
    link.href = "_denchou_settings_v0.2.2.css";
  ...
  async function getModelName() {
    ...
    try {
      ...
      /* not in review mode, fall through */
    }
    ...
    try {
      ...
      if (!models || models.length === 0)
        throw new Error("No note types found.");
      ...
      return new Promise((resolve, reject) => {
        const isDark =
          ...
          document.documentElement.classList.contains("custom-dark-mode");
        const bg = isDark ? "oklch(23.5% 0.0 89.88)" : "oklch(96% 0.018 92)";
        const fg = isDark
          ? "oklch(91.89% 0.0 89.88)"
          : "oklch(32.11% 0.0 89.88)";
        const muted = isDark
          ? "oklch(62.68% 0.0 89.88)"
          : "oklch(68.3% 0.0 89.88)";
        const border = isDark
          ? "oklch(44.95% 0.0 89.88)"
          : "oklch(84.52% 0.0 89.88)";
        const hoverBg = isDark
          ? "oklch(96% 0.018 92 / 0.08)"
          : "oklch(10% 0.02 260 / 0.04)";
        ...
        box.innerHTML =
          '<div style="font-size:16px;font-weight:600;margin-bottom:12px;">Note Type?</div><div style="font-size:13px;opacity:0.6;margin-bottom:16px;">Select the note type to save styling to:</div>';
        ...
        cancelBtn.onmouseenter = () => {
          ...
          cancelBtn.style.borderColor = muted;
        };
        cancelBtn.onmouseleave = () => {
          cancelBtn.style.opacity = "0.8";
          cancelBtn.style.borderColor = border;
        };
        cancelBtn.onclick = () => {
          overlay.remove();
          resolve(null);
  ...
  async function saveToAnki() {
    ...
    try {
      ...
      const styleInfo = await invokeAnkiConnect("modelStyling", {
        modelName: modelName,
      });
      ...
      const items = Object.values(groups).flatMap((g) =>
        Array.isArray(g) ? g : g.items,
      );
      ...
      items.forEach((item) => {
        ...
        if (item.type === "textarea") {
          ...
          const blockRegex =
            /\/\* CUSTOM CSS START \*\/[\s\S]*?\/\* CUSTOM CSS END \*\//g;
          ...
          if (regex.test(modifiedCss)) {
            modifiedCss = modifiedCss.replace(
              regex,
              (match, prefix, oldVal, semi, padding, comment) => {
                ...
                if (diff > 0) {
                  if (padding.length >= diff)
                    newPadding = padding.substring(diff);
                  else newPadding = "";
                } else if (diff < 0) {
  ...
  async function loadPresetsFromFile() {
    ...
    try {
      const response = await fetch(
        `${PRESET_FILENAME}?t=${new Date().getTime()}`,
      );
      if (response.ok) {
    ...
    if (!presets || Object.keys(presets).length === 0) {
      ...
      if (cached) {
        try {
          ...
          console.warn(
            "denchou_presets_cache parse failed, falling back to defaults:",
            e,
          );
          presets = {};
        }
  ...
  async function loadDeckLinksFromFile() {
    try {
      const response = await fetch(
        `${DECK_PRESETS_FILENAME}?t=${new Date().getTime()}`,
      );
      if (response.ok) {
        const links = await response.json();
        localStorage.setItem(
          "denchou_deck_presets_cache",
    ...
    if (cached) {
      try {
        ...
        console.warn("denchou_deck_presets_cache parse failed:", e);
      }
    }
    return {};
  }
  ...
  async function renderDeckLinksUI() {
    ...
    if (deckNames.length === 0) {
      linksHtml =
        '<div class="denchou-deck-links-empty">No decks are currently linked to a preset.</div>';
    } else {
  ...
  function getCurrentSettings() {
    ...
    items.forEach((item) => {
      ...
      if (
        (val === null || val === "null") &&
        activePreset &&
        presetsCache[activePreset] &&
        presetsCache[activePreset][item.var] !== undefined
      ) {
      ...
      items.forEach((item) => {
        ...
        if (input) {
          if (item.type === "switch-bool" || item.type === "switch-int") {
            ...
            if (
              ...
              input.previousElementSibling.type === "color"
            ) {
              input.previousElementSibling.value = oklchToHex(
                getSafeOklchColor(savedVal || "oklch(10% 0.02 260)"),
              );
            }
        ...
        if (item.type === "segment") {
          const btns = document.querySelectorAll(
            `.denchou-segment-btn[onclick*="${item.var}"]`,
          );
          const clean = (s) =>
            s
              ? s
  ...
  async function renderPresetUI() {
    ...
    const container = document.getElementById(
      "denchou-custom-select-container",
    );
    if (!container) return;
  ...
  function triggerUpdates() {
    ...
    if (
      ...
      activePreset &&
      presetsCache[activePreset] &&
      presetsCache[activePreset]["user-custom-css"] !== undefined
    ) {
    ...
    if (typeof window.toggleDefinition === "function")
      window.toggleDefinition();
    if (typeof window.noDuplicateKana === "function") window.noDuplicateKana();
    if (typeof window.initializeAudioSentenceState === "function")
      window.initializeAudioSentenceState();
    if (typeof window.initializeSentenceState === "function")
      window.initializeSentenceState();
    if (typeof window.initializeHintState === "function")
      window.initializeHintState();
    if (typeof window.dynamicCardHeight === "function")
      window.dynamicCardHeight();
    if (typeof window.enableInteractions === "function")
      window.enableInteractions();
    if (typeof window.denchouRefreshScenes === "function")
      window.denchouRefreshScenes();
  ...
  function buildMenu() {
    ...
    for (const [groupName, groupData] of Object.entries(groups)) {
      ...
      const groupMobileHidden = Array.isArray(groupData)
        ? false
        : groupData.mobileHidden || false;
      ...
      if (hasHeaders) {
        ...
        items.forEach((item) => {
          ...
          if (item.type === "header") {
            ...
            const mobileClass =
              item.mobileHidden && window.IS_MOBILE
                ? " denchou-mobile-hidden"
                : "";
    ...
    modal.querySelectorAll("input, textarea").forEach((input) => {
      ...
      if (type === "color" && input.type === "color") {
        ...
        input.addEventListener("input", () => {
          ...
          const rgbaMatch = currentVal.match(
            /rgba\(\s*\d+\s*,\s*\d+\s*,\s*\d+\s*,\s*([0-9.]+)\s*\)/i,
          );
          const tripletMatch = currentVal.match(
            /^\s*\d+\s*,\s*\d+\s*,\s*\d+\s*$/,
          );
          const oklchAlphaMatch = currentVal.match(
            /^oklch\([^)]+\)\s*\/\s*([0-9.]+)\s*$/i,
          );
  ...
  function generateControlHtml(item, rowStyle) {
    ...
    if (currentVal === null || currentVal === "null") {
      if (item.var === "user-custom-css") {
        ...
        if (
          (!currentVal || currentVal === "" || currentVal === "initial") &&
          computedCard
        ) {
    ...
    if (item.type === "switch-bool" || item.type === "switch-int") {
      ...
      let exactMatchIndex = item.options.findIndex(
        (opt) => clean(opt.val) === curClean,
      );
      let resolvedMatchIndex = -1;

      if (exactMatchIndex === -1 && resolvedCur !== "") {
        resolvedMatchIndex = item.options.findIndex(
          (opt) => clean(resolve(opt.val)) === resolvedCur,
        );
      }
    ...
    let className =
      item.type === "textarea"
        ? "denchou-row denchou-row-full"
        : rowStyle === "standard"
          ? "denchou-row standard"
          : "denchou-row";
  ...
  window.switchTab = function (navItem, panelId) {
    document
      .querySelectorAll(".denchou-nav-item")
      .forEach((el) => el.classList.remove("active"));
    navItem.classList.add("active");
    document
      .querySelectorAll(".denchou-panel")
      .forEach((el) => el.classList.remove("active"));
  ...
  window.updateSegment = function (btn, varName, val) {
    ...
    group
      .querySelectorAll(".denchou-segment-btn")
  ...
  window.denchouReset = async function () {
    const statusBtn = document.querySelector(
      ".denchou-footer-right button:first-child",
    );
    ...
    try {
      const response = await fetch("_denchou_defaults_v0.2.2.css");
      if (!response.ok)
        throw new Error(
          "File '_denchou_defaults_v0.2.2.css' not found in media folder.",
        );
      ...
      items.forEach((item) => {
        ...
        if (match) {
          ...
          if (replaceRegex.test(modifiedCss)) {
            modifiedCss = modifiedCss.replace(
              replaceRegex,
              (m, prefix, oldVal, semi, padding, comment) => {
                if (clean(oldVal) !== clean(defaultValue)) {
                  changesCount++;
                }

                if (!comment)
                  return `${prefix}${defaultValue}${semi}${padding}`;
            ...
            if (input) {
              if (item.type === "switch-bool" || item.type === "switch-int") {
                ...
                if (
                  ...
                  input.previousElementSibling.value =
                    getSafeOklchColor(defaultValue);
                }
              } else {
                if (item.type === "slider") {
  ...
  async function init() {
    try {
      ...
      console.warn("loadPresetsFromFile failed:", e);
    }
    try {
      await loadDeckLinksFromFile();
    } catch (e) {
      console.warn("loadDeckLinksFromFile failed:", e);
    }
    ...
    try {
      ...
      console.warn("preset selection failed:", e);
    }

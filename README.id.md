...
Fork ini bercabang dari [Senren](https://github.com/BrenoAqua/Senren), tapi arahnya dibuat berbeda: kartu复习 yang tenang, ringan, dan mengutamakan AnkiDroid, supaya tetap nyaman dipakai dalam sesi belajar yang lama.
...
- Gen Interface JP sebagai font antarmuka bawaan, dengan fallback字体 Jepang yang umum
- Ikon SVG Lucide sebaris, tanpa memuat字体 ikon utuh
- Panel preferensi bawaan untuk mengubah perilaku kartu saat復習
...
Senren memberi fondasi yang kuat: kartu responsif, pengaturan lengkap, tampilan kamus, dukungan aksen nada, penanganan gambar, kontrol audio, dan kustomisasi saat復習.
...
Kalau font ini belum tersedia secara lokal atau lewat CDN, DenChou akan fallback ke字体 Jepang umum dari sistem.
...
Pakai berkas di [`Template/`](Template/) dan ikuti alur pembaruan模板 di [`Template/README.md`](Template/README.md): ganti bagian Front Template, Back Template, dan Styling di Anki.

Dokumen pemasangan lama di [`docs/setup_overview.md`](docs/setup_overview.md) diwariskan dari Senren dan mungkin masih menyebut nama上游 selagi fork ini dibersihkan.
...
Kalau ragu, berkas模板 DenChou dan [`Template/DESIGN.md`](Template/DESIGN.md) adalah sumber kebenaran untuk fork ini.
